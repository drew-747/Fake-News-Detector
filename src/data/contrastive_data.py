...
class ContrastiveFakeNewsDataModule:
    ...
    def prepare_data(self) -> None:
        ...
        self.train_dataset = ContrastiveFakeNewsDataset(
            train_texts, train_labels, self.tokenizer, self.max_length
        )
        self.val_dataset = ContrastiveFakeNewsDataset(
            val_texts, val_labels, self.tokenizer, self.max_length
        )
        self.test_dataset = ContrastiveFakeNewsDataset(
