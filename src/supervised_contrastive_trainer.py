...
class SupervisedContrastiveTrainer:
    ...
    def supervised_contrastive_loss(self, features: torch.Tensor, labels: torch.Tensor, temperature: float = 0.07) -> torch.Tensor:
    ...
    def train(self, num_epochs: int = 10, save_dir: str = 'models') -> None:
        ...
        for epoch in range(num_epochs):
            ...
            if val_metrics['loss'] < best_val_loss:
                ...
                torch.save(self.model.state_dict(), os.path.join(save_dir, 'best_supervised_contrastive_model.pt'))
